...
from sqlalchemy import MetaData, Table, Column, String, Date, Float, LargeBinary, ForeignKey, or_, and_
from sqlalchemy.sql import select
import json #may need to remove
import datetime
...
class PanelAppDB:
    def __init__(self, db_url='sqlite:///panel_app_db.db'):
        ...
        self.panels = Table('panels', self.metadata,
                            ...
                            Column('r_code', String(255), nullable=False),
...
#return a boolean indicating whether the operation was successful
    ...
    def insert_panel_record(self, unique_panel_id, r_code, version, gene_details, JSON, BED_file_GrCH37, BED_file_GrCH38):

        list_of_unique_id_and_version = self.connection.execute(db.select(self.panels.columns.version)
...
#use input r_code to select highest panel version
    ...
    def retrieve_highest_version_json(self, r_code):
...
if (__name__ == "__main__"):
    ...
    db_manager.insert_patient_record('EX100', 'PID10', 'R111-1.1', datetime.date(2023, 12, 10))
    db_manager.insert_patient_record('EX122', 'PID15', 'R111-1.2', datetime.date(2024, 1, 18))
    db_manager.insert_patient_record('EX135', 'PID23', 'R111-1.3', datetime.date(2024, 1, 20))
    ...
    db_manager.insert_panel_record('R111-1.1', 'R111', 1.1, 'MTHFR, HGNC;7436, 1:11845780-11866977, 1:11785723-11806920', json_data_bytes, '', '')
    db_manager.insert_panel_record('R111-1.2', 'R111', 1.2, 'MTHFR, DHFR, HGNC;7436, 1:11845780-11866977, 1:11785723-11806920', json_data_bytes, '', '')
    db_manager.insert_panel_record('R111-1.3', 'R111', 1.3, 'MTHFR, DHFR, HGNC;7436, 1:11845780-11866977, 1:11785723-11806920', json_data_bytes, '', '')
    ...
    highest_version_and_json = db_manager.retrieve_highest_version_json('R111')
